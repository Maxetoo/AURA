...
const verifyTherapistAccountEmail = (email, firstname, web_url) => {
...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Hi ${firstname},</p>
            <p>Thank you for signing up with AURA (AI for Understanding and Recovery Assistance) as a therapist. Your application has been sent for reviewed</p>
            <a href="${web_url}" class="verify-button">BACK TO AURA</a>
    ...
    const subject = "AURA Account in Review";

    return sendCustomZeptoEmail(email, firstname, subject, HTML_content);
};

module.exports = verifyTherapistAccountEmail;